-- รายงานอุบัติเหตุทางการจราจร (คิวรี่ล่าสุดแบบ JSON) v2 - เพิ่มข้อมูลแอลกอฮอล์
...
SELECT
    ...
    CASE ost.export_code
        ...
        ELSE '-'
    END                                             AS status,
    -- แอลกอฮอล์ (จาก er_nursing_detail → accident_alcohol_type) 1=ดื่ม, 0=ไม่ดื่ม/ไม่ทราบ/ไม่มีข้อมูล
...
FROM ovst v
    ...
    LEFT JOIN accident_alcohol_type aat
        ON aat.accident_alcohol_type_id = nd.accident_alcohol_type_id
    -- Join ที่อยู่
